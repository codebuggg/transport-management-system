        ...
        <div class="relative flex items-center justify-between h-16">
            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div class="hidden sm:block sm:ml-6" >
                    ...
                    <div class="flex">
                            <a href="{{route('dashboard')}}" class="{{ (request()->is('dashboard')) ? 'primary-text-color bg-gray-200 focus:outline-none ' : '' }} px-3 py-2 rounded-md text-sm font-medium leading-5 text-white focus:outline-none focus:text-white hover:text-gray-700 hover:bg-white focus:bg-gray-700 transition duration-150 ease-in-out">Dashboard</a>
                            <a href="{{route('drivers')}}" class="{{ (request()->is('drivers*')) ? 'primary-text-color bg-gray-200 focus:outline-none' : '' }} px-3 py-2 rounded-md text-sm font-medium leading-5 text-white focus:outline-none focus:text-white hover:text-gray-700 hover:bg-white focus:bg-gray-700 transition duration-150 ease-in-out">Drivers</a>
                            ...
                            <a href="#" class="{{ (request()->is('messages*')) ? 'primary-text-color bg-gray-200 focus:outline-none ' : '' }} px-3 py-2 rounded-md text-sm font-medium leading-5 text-white focus:outline-none focus:text-white hover:text-gray-700 hover:bg-white focus:bg-gray-700 transition duration-150 ease-in-out">Messages</a>
