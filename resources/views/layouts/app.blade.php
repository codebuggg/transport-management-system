            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div class="hidden sm:block sm:ml-6" >
                    ...
                    <div class="flex">
                            ...
                            <a href="{{route('sales')}}" class="{{ (request()->is('sales*')) ? 'primary-text-color bg-gray-200 focus:outline-none' : '' }} px-3 py-2 rounded-md text-sm font-medium leading-5 text-white focus:outline-none focus:text-white hover:text-gray-700 hover:bg-gray-700 focus:bg-gray-700 transition duration-150 ease-in-out">Sales</a>
                            <a href="{{route('expense')}}" class="{{ (request()->is('expense*')) ? 'primary-text-color bg-gray-200 focus:outline-none ' : '' }} px-3 py-2 rounded-md text-sm font-medium leading-5 text-white focus:outline-none focus:text-white hover:text-gray-700 hover:bg-gray-700 focus:bg-gray-700 transition duration-150 ease-in-out">Expense</a>
                            <a href="{{route('messages')}}" class="{{ (request()->is('messages*')) ? 'primary-text-color bg-gray-200 focus:outline-none ' : '' }} px-3 py-2 rounded-md text-sm font-medium leading-5 text-white focus:outline-none focus:text-white hover:text-gray-700 hover:bg-gray-700 focus:bg-gray-700 transition duration-150 ease-in-out">Messages</a>
